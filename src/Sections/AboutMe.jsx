          ...
          <div className="max-w-4xl mx-6 ">
            ...
            <div className="bg-[#211b32] rounded-xl p-8 text-white text-lg  hover:shadow-2xl cursor-pointer">
              <p className="mb-8">
                ...
                the art of frontend web development but also diving deep into
              ...
              <p className="mb-8">
                ...
                interfaces or exploring the endless possibilities of
                decentralized apps, I'm constantly fueled by curiosity and
                creativity.
              </p>
              <p>
                ...
                next big project. Let's join forces and revolutionize the web,
                one blockchain-powered masterpiece at a time!
              </p>
            </div>
          </div>
        </div>
